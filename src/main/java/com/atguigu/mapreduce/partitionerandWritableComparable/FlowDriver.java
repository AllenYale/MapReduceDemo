...
//        job.setMapOutputValueClass(FlowBean.class);
        ...
        //6；设置数据的输入路径和输出路径
        FileInputFormat.setInputPaths(job, new Path("E:\\doc\\learning\\hadoop_learning\\test_code\\output4"));
        FileOutputFormat.setOutputPath(job, new Path("E:\\doc\\learning\\hadoop_learning\\test_code\\output7_partitionerandWritableComparable"));
